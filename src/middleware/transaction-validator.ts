...
const newTransactionValidation = () => {
    ...
    return [
        ...
        body('date').notEmpty().withMessage("Missing date").isISO8601().withMessage("Transaction date must be a valid numeric timestamp"),
...
const editTransactionValidation = () => {
    ...
    return [
        ...
        body('date').optional().isISO8601().withMessage("Transaction date must be a valid numeric timestamp"),
